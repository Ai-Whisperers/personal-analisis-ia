"""
Main Entry Point for Personal Comment Analyzer
Streamlit application entrypoint - clean UI router
"""
...
from config import PAGE_CONFIG, APP_INFO, FEATURE_FLAGS, validate_config
from utils.logging_helpers import setup_logging, get_logger
from utils.streamlit_helpers import get_state_manager

# Initialize logging
setup_logging(level="INFO", log_to_console=True, log_to_file=True)
